...
@php
  ...
  $classes = $active
      ? 'relative inline-flex items-center px-1 pt-1 border-b-2 border-yellow-400 dark:border-yellow-600 text-sm font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-yellow-700 transition duration-150 ease-in-out cursor-pointer'
